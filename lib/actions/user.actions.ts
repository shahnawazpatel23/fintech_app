...
export async function getLoggedInUser() {
  ...
  export const createLinkToken = async (user: User) => {
    try {
      ...
      console.log('error occured while creating link',error);
    }
  }
  ...
  export const createBankAccount = async({
    ...
    try {
      ...
      console.log('error occured in creating bank account in user.action file',error)
    }
  }
  ...
  export const getBanks=async({userId}:getBanksProps)=>{
    try {
      ...
      console.error('Error occurred in getBanks function:-',error);    }
  }
  ...
  export const getBank=async({documentId}:getBankProps)=>{
    try {
      ...
      console.error('Error occurred in getBank function:-',error);    }
  }
